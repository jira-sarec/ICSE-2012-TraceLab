...
Experiment Area - Located in upper right. This is the main working area for the experiment. Components can be
 dragged into this area to add them to the experiment.
Components Library - Viewed on the left by selecting the Components Library tab located at bottom left. A
 collection of components can be found here. These components can be added to the experiment area by dragging
 and dropping.
Workspace View - Viewed on the left by selecting the Workspace View tab located at bottom left. Stores data
 associated with the current experiment.
Output View - Located at the bottom. Stores messages on current events in TraceLab. This includes messages
 from TraceLab and experiments. It is useful for keeping a log of events and displaying errors.
